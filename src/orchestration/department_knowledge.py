...
_DEFAULT_SOURCE_PROFILES: dict[str, dict[str, Any]] = {
    "company": {
        ...
        "sources": [
            ...
            },
            {
                ...
                "search_patterns_de": ["statista <branche> marktvolumen deutschland umsatz", "statista <branche> unternehmen umsatzverteilung", "statista <produktkategorie> absatz preis entwicklung"],
                "search_patterns_en": ["statista <industry> market volume germany", "statista <company> revenue sector benchmark"],
                "fallback_label": "keine freien Quellen",
            },
        ],
    },
    "market": {
        ...
        "sources": [
            ...
            {
                "name": "VDMA Konjunkturbericht",
                "url": "https://www.vdma.org/konjunktur-statistik",
                "department": "MarketDepartment",
                "priority": "industry_publications",
                "free_access": "public",
                "evidence_type": "hard",
                "confidence_weight": 0.8,
                "search_patterns_de": ["vdma <branche> auftragseingang maschinenbau rückgang", "vdma <branche> marktbericht nachfrage überkapazität", "vdma <branche> export lieferzeiten preisdruck"],
                "search_patterns_en": ["vdma <industry> order intake mechanical engineering decline", "vdma <industry> market report supply pressure"],
                "fallback_label": "keine freien Quellen",
            },
            {
                "name": "Google Trends",
    ...
    "contact": {
        ...
        "sources": [
            {
                "name": "Northdata Geschäftsführung",
                "url": "https://www.northdata.de/",
                "department": "ContactDepartment",
                ...
                "evidence_type": "hard",
                "confidence_weight": 0.9,
                "search_patterns_de": ["northdata <firma> geschäftsführer vorstand prokura", "northdata <firma> leitende angestellte finanzchef", "<firma> impressum geschäftsführung prokura team", "<firma> leitung einkauf operations aftermarket"],
                "search_patterns_en": ["northdata <company> managing director board officers", "<company> management team leadership page", "<company> board of directors CFO procurement head"],
                "fallback_label": "keine freien Quellen",
            },
            {
